const prepareSimulation = () => {
    ...
    input = input.replace(/^\s+|\s+$/g, "").replace(/\s+/g, " ") // Remove extra whitespace
...
//---------------------- Helper functions for prepareSimulation ----------------------------
...
//---------------------- Helper functions for startSimulation ------------------------------
const replaceModalContent = (totalTime) => {
    replaceModalHeader();
    replaceModalBody(totalTime);
...
const replaceModalBody = (totalTime) => {
    // New node
...
//-------------------------- Helper functions for finishSimulation -------------------------
const resetContent = () => {
    // Reset textfield
